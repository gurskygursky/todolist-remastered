...
export function App() {
    ...
    const removeTask = (id: number) => {
        todolist1 = todolist1.filter(task => task.id !== id)
    ...
    return (
        <div className="App">
            <Todolist todolistTitle={'What to learn 111'} tasks={todolist1} removeTask={removeTask}/>
            <Todolist todolistTitle={'What to learn 222'} tasks={todolist2} removeTask={removeTask}/>
        </div>
    );
}
